...
<?php
$mode = get_theme_mod('fms_hero_mode', 'image');
        ...
        <?php if ($title || $text): ?>
            <div class="fms-hero-overlay">
                <div class="fms-hero-content">
                    ...
                    <?php if ($text && $btn): ?>
                        <a href="<?php echo esc_url($link); ?>" class="fms-hero-btn">
...
<?php else: ?>
    ...
    <section class="fms-hero-slider">
        ...
        <?php for ($i = 1; $i <= 3; $i++): ?>
            ...
            <?php
            $img   = fms_get_theme_image_url(get_theme_mod('fms_slide_'.$i.'_image'));
            ...
            <div class="fms-slide<?php echo $i === 1 ? ' active' : ''; ?>"
