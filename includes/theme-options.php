...
<a href="?page=fms-theme-options&tab=governance"
class="nav-tab <?php echo $tab==='governance' ? 'nav-tab-active' : ''; ?>">
Gouvernance
</a>
    
<a href="?page=fms-theme-options&tab=institution"
class="nav-tab <?php echo $tab==='institution' ? 'nav-tab-active' : ''; ?>">
Institution
</a>
